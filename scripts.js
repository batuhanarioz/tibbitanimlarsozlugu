...
function searchWord() {
  ...
  const containsResults = data.filter(
    (item) =>
...
document
  .getElementById("chatbot-open-btn")
...
document
  .getElementById("chatbox-close-btn")
  .addEventListener("click", function () {
...
function botResponse(userMessage) {
  ...
  if (lowerMessage.includes("android")) {
    response =
      'Android uygulamamıza buradan ulaşabilirsiniz: <a href="https://apps.apple.com/tr/app/t%C4%B1bbi-tan%C4%B1mlar-s%C3%B6zl%C3%BC%C4%9F%C3%BC/id6503453705?l=tr" target="_blank">Tıbbi Tanımlar Sözlüğü</a>';
  } else if (lowerMessage.includes("ios")) {
    response =
      'iOS uygulamamıza buradan ulaşabilirsiniz: <a href="https://apps.apple.com/tr/app/t%C4%B1bbi-tan%C4%B1mlar-s%C3%B6zl%C3%BC%C4%9F%C3%BC/id6503453705?l=tr" target="_blank">Tıbbi Tanımlar Sözlüğü</a>';
  } else if (
    lowerMessage.includes("destek") ||
    lowerMessage.includes("iletişim")
  ) {
    response =
      'Destek için bize email atabilirsiniz: <a href="mailto:tibbitanimlarsozlugu@gmail.com">tibbitanimlarsozlugu@gmail.com</a>';
  } else if (lowerMessage.includes("batu")) {
    response =
      'İşte Linkedin Hesabım: <a href="https://www.linkedin.com/in/batuhanarioz" target="_blank">Batuhan ARIÖZ</a>';
  } else {
    response =
      "Üzgünüm, bu soruya yanıt veremiyorum. Başka bir konuda yardımcı olabilir miyim?";
  }
